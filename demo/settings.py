...
SECRET_KEY = '9b1eppr9juk*m*=*-b-%2nim%kjoxsep-o=imdv8^xf)t-xgc2'
...
MIDDLEWARE = [
    ...
    'utils.custommiddleware.QueryCountDebugMiddleware',
]
...
# AUTHENTICATION_BACKENDS = ('users.UsernameOrEmailBackend')
